...
import { RootTool, YarnTool, PnpmTool, LernaTool, RushTool, BoltTool } from '@manypkg/tools';
 ...
 * checked last.
 */
const DEFAULT_TOOLS = [YarnTool, PnpmTool, LernaTool, RushTool, BoltTool, RootTool];
